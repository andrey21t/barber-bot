...
# ============================================================
# Session 5.62 (пункт 2): admin_inline_menu после удаления "Открыть день"
# ============================================================


def test_admin_inline_menu_has_6_buttons_no_openday() -> None:
    """admin_inline_menu() имеет 6 кнопок (не 7) и НЕ содержит «Открыть день».
